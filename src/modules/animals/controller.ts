...
import { createAnimalsSchema, updateAnimalsSchema } from './schema';
...
export class AnimalsController {
  ...
  public async getAll(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const { data, total } = await this.service.getAll(skip, take, search, isolationUserId(req));
  ...
  public async create(req: Request, res: Response, next: NextFunction) {
    try {
      const parsed = createAnimalsSchema.parse(req.body);
  ...
  public async update(req: Request, res: Response, next: NextFunction) {
    try {
      const payload = updateAnimalsSchema.parse(req.body);
